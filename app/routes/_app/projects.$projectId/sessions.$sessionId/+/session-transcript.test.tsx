...
vi.mock("~/lib/projects/opencode.client", () => ({
...
describe("SessionTranscript", () => {
  ...
  function renderTranscript() {
    const view = render(
      <SessionTranscript
        actionPath="/projects/project-1/sessions/session-1"
  ...
  it("loads and prepends older message pages from the top boundary", async () => {
    ...
    expect(listOpencodeMessagePageClient).toHaveBeenCalledWith("project-1", "session-1", {
      before: "cursor-1",
      limit: 50,
    });
