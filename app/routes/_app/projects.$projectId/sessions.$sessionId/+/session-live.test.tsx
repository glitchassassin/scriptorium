...
const useProjectEvents = vi.fn();

vi.mock("~/components/events/project-events-provider", () => ({
  useProjectEvents: (...args: unknown[]) => useProjectEvents(...args),
}));
...
describe("SessionLiveProvider", () => {
  ...
  it("surfaces live session info, status, and errors", () => {
    ...
    useProjectEvents.mockImplementation((nextCallback: typeof callback) => {
