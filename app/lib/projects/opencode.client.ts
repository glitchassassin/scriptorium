...
function getProjectProxyPath(projectId: string, path: string) {
  return `/projects/${projectId}/proxy${path}`;
}
...
export async function listOpencodeMessagePageClient(
  ...
  const response = await fetch(getProjectProxyPath(projectId, `/session/${sessionId}/message${suffix}`));
...
export async function listOpencodePermissionRequestsClient(projectId: string, sessionId?: string) {
  const response = await fetch(getProjectProxyPath(projectId, "/permission"));
...
export async function replyToOpencodePermissionRequest(
  ...
  const response = await fetch(getProjectProxyPath(projectId, `/permission/${requestId}/reply`), {
    method: "POST",
    headers: {
...
export async function listOpencodeQuestionRequestsClient(projectId: string, sessionId?: string) {
  const response = await fetch(getProjectProxyPath(projectId, "/question"));
...
export async function replyToOpencodeQuestionRequest(
  ...
  const response = await fetch(getProjectProxyPath(projectId, `/question/${requestId}/reply`), {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function rejectOpencodeQuestionRequest(projectId: string, requestId: string) {
  const response = await fetch(getProjectProxyPath(projectId, `/question/${requestId}/reject`), {
    method: "POST",
  });
